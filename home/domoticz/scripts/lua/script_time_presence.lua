...
if (otherdevices['Presence']=='Off' or (otherdevices['Presence']=='On' and timedifference(otherdevices_lastupdate['Presence']) > 60)) then
        ping_success_tel1=os.execute('ping -c2 -w7 192.168.1.32')
        --ping_success_tel2=os.execute('ping -c1 -w1 192.168.1.32')

        if ping_success_tel1 then
--      or ping_success_tel2 then
